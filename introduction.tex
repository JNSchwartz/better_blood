...
% https://ieeexplore.ieee.org/abstract/document/6588092
...
The primary objective of this research is to propose a modification for the described architecture to accelerate and decrease computational needs. To achieve these it proposes to decrement the number of selected features and replace the ResNet50. In cases, where the available data is imbalanced ResNet50V2 performs better, then ResNet50. %https://www.sciencedirect.com/science/article/pii/S2352914820302537#bib33
 
% present the chapters/sections
